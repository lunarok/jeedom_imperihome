...
<div class="row row-overflow">
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    <legend><i class="fa fa-table"></i>  {{Mes Imperihome}}
    </legend>
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        if (in_array($test, $files)) {
          ...
          $path = 'imperihome_icon';
        }
        echo '<img src="plugins/imperihome/doc/images/' . $path . '.png" height="105" width="95" />';
        echo "</center>";
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement Imperihome}}"/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="addr" type="text" placeholder="{{saisir ip du imperihome}}">
              </div>
            </div>
